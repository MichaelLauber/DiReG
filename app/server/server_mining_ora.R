...
`%||%` <- function(x, y) if (is.null(x)) y else x
  ...
  observeEvent(input$submit_prompt_ora_btn, {
    ...
    user_prompt <- paste0("I am scientist interested in direct reprogramming. 
                        I have a gene set that gets activated when overexpressing a set of TFs and have performed over-representation analysis on it.
                        Tell me do the enriched genesets show specifity for: ", 
                          ...
                          paste(cache$enrichData$result$term_name, 
                                collapse = ", "),
                          ". Return Answer with Markdown Formatting. It will be displayed within an web-application. Keep it concise. Do not ask follow up questions."
                          )
